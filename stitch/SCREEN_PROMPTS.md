# SWAG - Stitch Screen Prompts

These six prompts are ready to paste into Stitch MCP. Use with `stitch/DESIGN.md` and `AGENT_CONTEXT.md`.
...
```text
SWAG statement poster. Background: #0A0A0A. Ghost bleed word top-right: "EXPRESSION" in Instrument Sans 700, Sand, 18vw, opacity 0.05, overflowing right edge. Four SWAG statement modules stacked vertically, left-aligned, Sand text on Black. Each module: small label "01" / "02" etc in Stone, 0.65rem; statement text in Instrument Sans 500, Sand, ~2.5rem, ALL CAPS. No cards, no dividers - only whitespace separates modules. Label top-left: "WHAT IS SWAG?" in Stone, ALL CAPS tracking 0.2em.
```

## Screen 4 - SWAG Poster on Sand (desktop)

```text
SWAG statement poster. Background: #D6D1C4 (Sand). Ghost bleed word: "AUTHORITY" in Void Black (#0A0A0A), 18vw, opacity 0.05, overflowing left edge. Three SWAG statement modules, same structure as Screen 3 but Void Black text on Sand. Label top-left: "WHAT IS SWAG?" in Stone (#575D61), ALL CAPS. Warm, editorial, high contrast.
```
...
```text
Closing statement section. Background: #0A0A0A. Single centred or left-aligned large display: "NOTHING" then newline "OWING." in Instrument Sans 700, Sand, ALL CAPS, ~10vw, tracking -0.04em, tight line-height 1.0. No other elements. Maximum negative space. Monumental scale.
```
